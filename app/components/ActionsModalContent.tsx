...
const ImageThumbnail = ({ file }: { file: Models.Document }) => (
    ...
    <Thumbnail type={file.type} extension={file.extension} url={constructFileUrl(file.bucketFileId)} />
    ...
    <div className="share-wrapper">
        ...
        <div className="pt-4">
            <div className="flex justify-between">
                ...
                <p className="subtilte-2 text-light-200">{file.users.length} users</p>
            </div>
            <ul className="pt-2">
